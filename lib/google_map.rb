...
require 'google_map/street_view'
require 'google_map/street_view_overlay'
require 'google_map/custom_control'
require 'google_map/street_view_overlay_control'
require 'google_map/street_view_button_control'
require 'google_map/pin_icon'